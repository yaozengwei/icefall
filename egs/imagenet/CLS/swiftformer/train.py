...
from swiftformer import SwiftFormer_XS
from swiftformer_local_global import SwiftFormer_XS_local_global
...
def get_model(params):
    if params.model_name == "XS":
        model = SwiftFormer_XS_local_global(num_classes=params.num_classes)
    elif params.model_name == "XS-baseline":
        model = SwiftFormer_XS(num_classes=params.num_classes)
    else:
        raise ValueError(params.model_name)
