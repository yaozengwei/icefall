    ...
    def __init__(
        ...
        for i in range(num_encoders):
            ...
            encoder_layer = Zipformer2EncoderLayer(
                ...
                pos_dim=encoder_dim[i],
                num_heads=num_heads[i],
                query_head_dim=query_head_dim[i],
                pos_head_dim=query_head_dim[i],
...
class RelPositionMultiheadAttentionWeights(nn.Module):
    ...
    def __init__(
        ...
        assert pos_dim == embed_dim, (pos_dim, embed_dim)
        assert pos_head_dim == query_head_dim, (pos_head_dim, query_head_dim)
