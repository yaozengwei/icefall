...
class Conv2dSubsampling(nn.Module):
    ...
    def __init__(
        ...
        self.conv = nn.Sequential(
            ...
            ScaleGrad(0.2),
            Balancer(out_channels, channel_dim=1, max_abs=1.0),
            SwooshR(),
            nn.Conv2d(
            ...
            Balancer(out_channels, channel_dim=1, max_abs=4.0),
            SwooshR(),
            # nn.Conv2d(
            #     in_channels=layer2_channels,
            #     out_channels=layer3_channels,
            #     kernel_size=3,
            #     stride=(2, 2),  # (time, freq)
            # ),
        ...
        self.out = nn.Linear(self.out_width * out_channels, out_channels)
