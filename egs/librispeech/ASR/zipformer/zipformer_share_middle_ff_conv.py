...
class Zipformer2(EncoderInterface):
    ...
    def __init__(
            ...
            share_ff: Union[bool, Tuple[bool]] = False,
            share_conv: Union[bool, Tuple[bool]] = False,
            pos_dim: int = 192,
        ...
        def _to_tuple(x):
            ...
            if len(x) == 1:
                ...
                assert len(x) == len(downsampling_factor) and isinstance(x[0], (int, bool))
            return x
        ...
        share_ff = _to_tuple(share_ff)
        share_conv = _to_tuple(share_conv)
...
class Zipformer2EncoderLayer(nn.Module):
    ...
    def __init__(
        ...
        if share_ff:
            self.feed_forward2 = self.feed_forward1
            self.feed_forward3 = self.feed_forward1
        else:
        ...
        self.conv_module1 = ConvolutionModule(embed_dim,
                                              ...
                                              causal=causal)
        if share_conv:
            self.conv_module2 = self.conv_module1
        else:
