...
from train import get_encoder_embed, get_encoder_model, get_joiner_model, add_model_arguments, get_params
# from train_no_attn_shared_layer import get_encoder_embed, get_encoder_model, get_joiner_model, add_model_arguments, get_params
