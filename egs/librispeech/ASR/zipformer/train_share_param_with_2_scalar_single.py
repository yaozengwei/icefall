...
from zipformer_share_param_with_2_scalar_single import Zipformer2
...
def add_model_arguments(parser: argparse.ArgumentParser):
    ...
    parser.add_argument(
        ...
        help="For each stack, whether share feedforward parameters in each layer",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="False,False,True,True,True,False",
        help="For each stack, whether share convolution parameters in each layer",
    )
...
def get_encoder_model(params: AttributeDict) -> nn.Module:
    encoder = Zipformer2(
        ...
        share_ff=_to_bool_tuple(params.share_ff),
        share_conv=_to_bool_tuple(params.share_conv),
        dropout=ScheduledFloat((0.0, 0.3), (20000.0, 0.1)),
