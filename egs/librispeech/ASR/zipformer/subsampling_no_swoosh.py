...
from zipformer_no_swoosh import Swish
...
class Conv2dSubsampling(nn.Module):
    ...
    def __init__(
        ...
        self.conv = nn.Sequential(
            ...
            Balancer(layer1_channels, channel_dim=1, min_abs=0.1, max_abs=0.5),
            # SwooshR(),
            nn.ReLU(),
            nn.Conv2d(
            ...
            Balancer(layer2_channels, channel_dim=1, min_abs=0.1, max_abs=2.0),
            # SwooshR(),
            nn.ReLU(),
            nn.Conv2d(
            ...
            Balancer(layer3_channels, channel_dim=1, min_abs=0.1, max_abs=2.0),
            # SwooshR(),
            nn.ReLU(),
        )
