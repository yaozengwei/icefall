...
class Zipformer2EncoderLayer(nn.Module):
    ...
    def __init__(
        ...
        self.share_ff_params()

    def share_ff_params(self) -> None:
        self.feed_forward2.out_proj = self.feed_forward1.out_proj
        self.feed_forward3.in_proj = self.feed_forward2.in_proj
