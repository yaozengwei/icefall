...
def get_model(params: AttributeDict) -> nn.Module:
    model = Vocoder(
        ...
        local_num_layers=params.local_num_layers,
        global_num_layers=params.global_num_layers,
        num_heads=params.num_heads,
        ff_hidden_factor=params.ff_hidden_factor,
        dropout=params.dropout,
        use_res_scale=params.use_res_scale,
